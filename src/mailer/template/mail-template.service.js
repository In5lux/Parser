...
${this.data[0].securing_requisition ? 'Обеспечение заявки: ' + this.data[0].securing_requisition : ''}

${this.data[0].securing_contract ? 'Обеспечение договора: ' + this.data[0].securing_contract : ''}
